...
int main() {
    ...
    destroy_single_linked_list(union1);
    destroy_single_linked_list(union2);
    destroy_single_linked_list(union3);
    destroy_single_linked_list(union4);
    destroy_single_linked_list(union5);
    destroy_single_linked_list(union6);
    destroy_single_linked_list(union7);
    destroy_single_linked_list(union8);
    destroy_single_linked_list(union9);
